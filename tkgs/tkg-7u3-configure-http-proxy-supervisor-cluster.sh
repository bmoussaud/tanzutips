...
echo "New state"
curl -k -X GET -H "vmware-api-session-id: ${session_id}" https://${vc_address}/api/vcenter/namespace-management/clusters/${cluster_id} | jq .cluster_proxy_config
