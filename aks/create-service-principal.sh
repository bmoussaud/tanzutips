...
echo "INSTALL_REGISTRY_PASSWORD=${PASSWORD}" > ~/${REGISTRY_FILE}
echo "INSTALL_REGISTRY_USERNAME=${USER_NAME}" >>  ~/${REGISTRY_FILE}
echo "INSTALL_REGISTRY_HOSTNAME=${ACR_NAME}.azurecr.io" >>  ~/${REGISTRY_FILE}
